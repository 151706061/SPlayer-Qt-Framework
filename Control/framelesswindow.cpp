...
CFramelessWindow::CFramelessWindow(QWidget *parent) : DraggableWidget(parent)
...
bool CFramelessWindow::nativeEvent(const QByteArray &eventType, void *message, long *result)
{
    ...
    case WM_GETMINMAXINFO:
    {
        ...
        if (::IsZoomed(msg->hwnd))
        {
            ...
            DraggableWidget::setContentsMargins(frame.left+m_margins.left(), \
        ...
        {
            DraggableWidget::setContentsMargins(m_margins);
        }
    ...
    default:
        return DraggableWidget::nativeEvent(eventType, message, result);
        break;
    }
}
